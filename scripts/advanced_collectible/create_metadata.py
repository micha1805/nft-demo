...
# copy pasted from Collins's repo :
breed_to_image_uri = {
...
def upload_to_ipfs(filepath):
    with Path(filepath).open("rb") as fp:
        ...
        # same structure : https://ipfs.io/ipfs/Qmd9MCGtdVz2miNumBHDbvj8bigSgTwnr4SbyH6DNnpWdt?filename=0-PUG.json
...
def main():
    ...
    for token_id in range(number_of_advanced_collectibles):
        ...
        if Path(metadata_filename).exists():
            ...
            collectible_metadata["breed"] = breed
